...
class Application(Frame):
    def __init__(self, master):
        ...
        self.concluded_option = Radiobutton(self.container1, text='Yes', variable=self.concluded, value='Yes')
        self.not_completed_option = Radiobutton(self.container1, text='No', variable=self.concluded, value='No')
        ...
        self.lblmsg = Label(self.container1, text="")
        self.lblmsg.grid(column=1, row=5)
    ...
    def search_reminder(self):
        ...
        self.input_reminder.delete(0, END)
        self.input_reminder.insert(INSERT, reminder.text_reminder)

        self.concluded.set(reminder.status_reminder)
